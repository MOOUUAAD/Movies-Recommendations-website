...
const Card = (movie) => {
  ...
  return (
    <div className='w-1/2 md:w-1/5 m-4 relative bg-sky-950 overflow-y-hidden shadow-md shadow-black hover:scale-105 duration-200 rounded group'>
        <img src={image_path+movie.info.poster_path} alt='not found' onError={addDefaultImg}
        className='' />

        <div className='p-3 flex flex-col justify-center items-center md:group cursor-default'>
